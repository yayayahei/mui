...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        meta: {
            ...
            pluginPickerPath: 'plugin/picker/',
            pluginPickerDistPath: 'plugin/picker/dist/',
        },
        ...
        watch: {
            ...
            scripts: {
                files: [
                    '<%= meta.sassPath %>/**/*.scss',
                    '<%= meta.jsPath %>/**/*.js',
                    '<%= meta.pluginPickerPath %>js/*.js',
                    '<%= meta.pluginPickerPath %>css/*.css',
                ],
                tasks: 'dist'
            },
            pluginPicker:{
    ...
    grunt.registerTask('build-plugin', ['shell:buildPicker']);
    grunt.registerTask('dist-plugin', ['build-plugin','copy:plugin']);
    grunt.registerTask('dist', ['clean:all', 'dist-css', 'dist-js', 'build-plugin', 'copy']);
    ...
    grunt.registerTask('server-plugin', ['dist-plugin', 'watch:pluginPicker',]);
